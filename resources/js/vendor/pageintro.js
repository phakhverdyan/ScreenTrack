...
(function() {
  var $container, $hole, $nav, $overlay, $tooltip, data, defaults, finish, getPosition, holeTemplate, init, overlayTemplate, select, setTooltipPosition, start, tooltipTemplate, update, skip;
  ...
  init = function(options) {
    ...
    var $actions, $btnSkip, $btnFinish, $btnNext, $li, actions, entry, i, j, len, ref;
    ...
    return $actions.append($btnSkip, $btnNext, $btnFinish);
  };
  ...
  finish = function(options) {
    options = options || {};
    var entry;
    entry = data.entries[data.entries.length - 1];
    
    if (options.skip) {
        data.onSkip && data.onSkip();
    } else {
        entry.onExit && entry.onExit();
    }
