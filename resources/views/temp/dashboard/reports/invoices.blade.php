        ...
        <div class="d-flex align-items-center justify-content-between mt-2 mb-4">
            <div class="d-flex align-items-center">
                <div class="form-group" >
                    ...
                    <select name="full_name" class="form-control" id="full_name_filter">
            ...
            <div class="align-items-lg-end">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="date_range" id="date_range_filter" value="{{ isset($_GET['date_range']) ? $_GET['date_range'] : date("m/d/Y",time()-86400 * 10) . " - " . date("m/d/Y",time()) }}">
                </div>
            </div>
        </div>
        <div class="form-group">
            <input type="submit" value="Apply Filter" class="btn btn-primary">
            <a href="{{route('dashboard.reports.invoices')}}" class="btn btn-danger">Reset Filter</a>
        </div>
        </form>
