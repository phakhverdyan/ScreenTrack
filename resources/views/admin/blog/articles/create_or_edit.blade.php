        ...
        $(function () {
            ...
            $('#article-save').click(function (event) {
                ...
                request({
                    ...
                    window.location.href = '/nexus/blog/articles';
...
@endpush
@section('content')
    <a href="/nexus/blog/articles" class="btn btn-secondary">< Back to Articles list</a>
    @empty($article)
        <h1>Create Article</h1>
        <form action="/blog_articles/create" id="article-form">
    @else
        <h1>Edit Article</h1>
        <form action="/blog_articles/{{ $article->id }}/update" id="article-form">
    @endempty
