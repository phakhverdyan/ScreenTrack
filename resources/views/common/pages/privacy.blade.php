...
@push('meta')
    <title>{!! __('meta.privacy.title') !!}</title>
    <meta name="description" content="{!! __('meta.privacy.description') !!}">
    <meta name="keywords" content="{!! __('meta.privacy.keywords') !!}">
@endpush
...
@section('content')
    ...
    <div class="container-fluid">
        <section>
            <div class="container">
                <h2 class="text-center">ScreenTrack, INC. Privacy Policy</h2>
                <p>
